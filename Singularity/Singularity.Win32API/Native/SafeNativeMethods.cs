...
namespace Singularity.Win32API
{
	public class SafeNativeMethods
	{
		...
		public virtual IntPtr OpenSCManager(string machineName, string databaseName, int access)
		{
			return PInvokeDeclarations.OpenSCManager(machineName, databaseName, access);
		}

		public virtual IntPtr OpenService(IntPtr databaseHandle, string serviceName, int access)
		{
			return PInvokeDeclarations.OpenService(databaseHandle, serviceName, access);
		}
 
		public virtual bool CloseServiceHandle(IntPtr handle)
		{
			return PInvokeDeclarations.CloseServiceHandle(handle);
		}

		public virtual bool DeleteService(IntPtr serviceHandle)
		{
